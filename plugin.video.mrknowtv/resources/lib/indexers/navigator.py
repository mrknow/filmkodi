...
class navigator:
    ...
    def root(self):
        self.addDirectoryItem(40007, 'tv&url=eskago', 'eskago.png', 'DefaultMovies.png')
    ...
    def tools(self):
        ...
        self.addDirectoryItem(30112, 'openSettings&query=1.0', 'settings.jpg', 'DefaultAddonProgram.png')
        ...
        self.addDirectoryItem(30121, 'loguploader', 'tools.jpg', 'DefaultAddonProgram.png')
