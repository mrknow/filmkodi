...
def decodeMrknow1(str):
    s=''
    for x in range(0,len(str)):
        s += _decode_char2(str[x])
    return s

def _decode_char2(c):
    array1 = ["4", "f", ".", "i", "Z", "C", "S", "A", "B", "E"]
    array2 = ["v", "m", "l", "x", "e", "a", "b", "c","s","z"]
    for i in range(0,len(array1)):
        if c == array1[i]: return array2[i][0]
        if c == array2[i]: return array1[i][0]
    return c
#http://207.110.52.61/s//hls/filmbox_extra_415/rVy8pXvT2HeHxnijlbz-Jw/1458187200/index.m3u8
#http://207.110.52.61/s//hls/filmbox_extra_415/rVy8pXvT2HeHxnijlbz-Jw/1458187200/index.m3u8

#print decodeMrknow1('http://8vl22l103l19v:8081/.x4Z/dxBAo4Zry-AhCnnZ./p.Cy.xBtlf3u8')
